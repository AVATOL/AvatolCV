...
public class ObsoleteLeafSegmentationDataPrepStep implements Step {
	private static final String FILESEP = System.getProperty("file.separator");
	private static final String NL = System.getProperty("line.separator");
	private BisqueSessionData sessionData = null;
	private View view = null;
	public ObsoleteLeafSegmentationDataPrepStep(View view, BisqueSessionData sessionData){
	...
	public void createDarwinDriverFile() throws AvatolCVException {
		...
		ddf.setImageDir(this.sessionData.getImagesLargeDir());
