classdef AlgorithmChoiceScreen < handle
    ...
    methods
        ...
        function displayQuestionnaireCompleteScreenForceCRF(obj) 
        ...
        function displayQuestionnaireCompleteScreenForceDPM(obj) 
            ...
            %set(H.prev, 'callback', {@backFromEndMessageScreen});
            obj.session.mostRecentScreen = 'QUESTIONNAIRE_COMPLETE'; 
            obj.session.quetsionnaireScreens.questionSequencer.persist();
        end
