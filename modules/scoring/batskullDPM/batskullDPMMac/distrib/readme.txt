...
================================
-run_batskullDPMMac.sh (shell script for temporarily setting environment variables and 
 executing the application)
   -to run the shell script, type
   
       ./run_batskullDPMMac.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v80, run the shell script as:
       ...
       ./run_batskullDPMMac.sh /mathworks/home/application/v80
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_batskullDPMMac.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
   -if end users are unable to download the MCR using the above  
    link, include it when building your component by clicking 
    the "Add MCR" link in the Deployment Tool
-The Macintosh bundle directory structure batskullDPMMac.app 
   -this can be gathered up using the zip command 
    zip -r batskullDPMMac.zip batskullDPMMac.app
    or the tar command 
    tar -cvf batskullDPMMac.tar batskullDPMMac.app
-This readme file 
...
A. Mac systems:
   ...
   the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_batskullDPMMac.sh 
