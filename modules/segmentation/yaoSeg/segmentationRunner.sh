...
do
	...
	elif [ "avatolCVMatlabLauncherPath" = "$key" ]; then
	    avatolCVMatlabLauncherPath=${val}
...
if [ "$avatolCVMatlabLauncherPath" = "" ]; then
    missingArg=1
	echo segRunConfig file missing entry for avatolCVMatlabLauncherPath
fi
...
echo avatolCVMatlabLauncherPath is ${avatolCVMatlabLauncherPath}
...
#MATLAB_RUNTIME_LAUNCHER=${avatolCVMatlabLauncherPath}
#
